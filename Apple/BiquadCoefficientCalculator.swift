...
*/
/*
	ELK 2023 Minor modifications to suit my needs
 */
import Accelerate


// frequency 12 - 20000
// resonance 0.1 - 25		(before db conversion)
struct BCParameters {
...
struct BiquadCoefficientCalculator {
...
#if true
	/*
	 * I prefer to deal with enums as Ints
	 */
	enum FilterType: Int {
		case passthrough = 0
		case lowpass
    ...
    enum FilterType: String, CaseIterable, Identifiable {
        ...
        case notch = "Notch"
//        case peakingEQ = "Peaking EQ"  // later
    ...
    static func coefficients(for parameters: BCParameters,
                             sampleRate: Int32) -> SectionCoefficients {
        
        let filterType = parameters.filterType
        let frequency = parameters.frequency
        let q = parameters.resonance
//        let dbGain = parameters.dbGain // deal with later
